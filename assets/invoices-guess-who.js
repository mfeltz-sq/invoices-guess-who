...
return Object.defineProperty(r,"__esModule",{value:!0}),r}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("invoices-guess-who/app").default.create({name:"invoices-guess-who",version:"0.0.0+ad837b33"})
