...
;define("invoices-guess-who/utils/person-data", ["exports"], function (_exports) {
  "use strict";
...
;
          if (!runningTests) {
            require("invoices-guess-who/app")["default"].create({"name":"invoices-guess-who","version":"0.0.0+43a53515"});
          }
