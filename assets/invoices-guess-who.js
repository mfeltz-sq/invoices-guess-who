...
;define("invoices-guess-who/components/guessing-card", ["exports", "invoices-guess-who/utils/person-data"], function (_exports, _personData) {
  ...
  var _default = Ember.Component.extend({
    ...
    init: function init() {
      ...
      (0, _personData.default)().then(function (result) {
        _this.set('people', result);
        _this.set('selectedPerson', getRandomPerson(result));
      });
    },
    selectedPerson: null,
    actions: {
      randomizePerson: function randomizePerson() {
...
define("invoices-guess-who/controllers/gameboard", ["exports"], function (_exports) {
  ...
  var GameboardController = (_dec = Ember._action, (_class = /*#__PURE__*/function (_Ember$Controller) {
    _inherits(GameboardController, _Ember$Controller);
    var _super = _createSuper(GameboardController);
    function GameboardController() {
      _classCallCheck(this, GameboardController);
      return _super.apply(this, arguments);
    }
    _createClass(GameboardController, [{
      key: "openPersonWindow",
      value: function openPersonWindow() {
        window.open("/your-card", 'your card', 'height=350,width=350');
      }
    }]);
    return GameboardController;
  }(Ember.Controller), (_applyDecoratedDescriptor(_class.prototype, "openPersonWindow", [_dec], Object.getOwnPropertyDescriptor(_class.prototype, "openPersonWindow"), _class.prototype)), _class));
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", loadedPeople);
          case 2:
            _context.next = 4;
            return fetch("".concat(_environment.default.rootURL, "assets/guesses.json"));
          case 4:
            response = _context.sent;
            _context.next = 7;
            return response.json();
          case 7:
            loadedPeople = _context.sent.map(function (person) {
              return _objectSpread(_objectSpread({}, person), {}, {
                img: "".concat(_environment.default.rootURL).concat(person.photoFilePath)
              });
            });
            loadedPeople.sort(function (left, right) {
...
;
          if (!runningTests) {
            require("invoices-guess-who/app")["default"].create({"name":"invoices-guess-who","version":"0.0.0+1f3e1a62"});
          }
